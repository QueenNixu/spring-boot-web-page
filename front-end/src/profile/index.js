                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-md-9">
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">Intro written by the user
                                                                with suported spaces</p>
                                        <p className="card-text"><small className="text-body-secondary">Likes: LeagueOfLegends, Philosofy, Guitar</small></p>
                                    </div>
                                </div>
